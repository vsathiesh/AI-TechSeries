...
<img src="http://139.59.61.161/Hackathon/Hackathon/MSWorkshop2019/Bot.PNG" alt="image" style="max-width: 100%;">&nbsp;
...
<ol>
	<strong>
		...
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal1.png" alt="image" style="max-width: 100%;">&nbsp;
		<li>Click on Create button</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal2.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Fill out all the details</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal3.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Scroll down and click on 'Microsoft App ID and password'</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal4.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Click on 'Create New'</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal5.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Click on 'Create App ID in the App Registration Portal'</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal6.PNG" alt="image" style="max-width: 100%;">&nbsp;
		...
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal9.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Copy your Password</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal10.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Copy your App ID</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal11.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Paste your app id and password</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal12.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Click on Create button</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal13.PNG" alt="image" style="max-width: 100%;">&nbsp;
		...
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal15.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Click on Channels, click on Edit</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal16.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Copy the Secret Key</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal17.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Paste the key in 'YOUR_SECRET_HERE'</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal18.PNG" alt="image" style="max-width: 100%;">&nbsp;
		<li>Grab the whole Web chat iframe code</li>&nbsp;
		<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Portal19.PNG" alt="image" style="max-width: 100%;">&nbsp;
...
<ol>
	...
	<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Bot4.PNG" alt="image" style="max-width: 100%;">&nbsp;
	<li>Navigate to the code line specified in the below image</li>&nbsp;
	<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Bot3.PNG" alt="image" style="max-width: 100%;">&nbsp;
...
&lt;link rel="stylesheet" type="text/css" href="http://139.59.61.161/MSWorkshop2019/chatbot.css"/&gt;
	...
	<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Bot51.PNG" alt="image" style="max-width: 100%;">&nbsp;
	<li>Paste the below code below the marked area</li>
		<blockquote>
			<pre>
				<code>
...
&lt;/div&gt;
	...
	<li>Scroll to the code line specified in the below image</li>&nbsp;
	<img src="http://139.59.61.161/Hackathon/MSWorkshop2019/BOT/Bot6.PNG" alt="image" style="max-width: 100%;">&nbsp;
	<li>Paste the below code below the marked area</li>
		<blockquote>
			<pre>
				<code>
